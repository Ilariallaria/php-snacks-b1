...
$paragraphDivision = explode(".", $paragraph);
?>
...
<head>
    ...
    <h2>Paragrafi derivati:</h2>
    
    <?php for($i = 0; $i < count($paragraphDivision); $i++) { ?>
        <?php $thisParagraph = $paragraphDivision[$i]; ?>

        <?php if(!empty($thisParagraph)) { ?>
            <p><?php echo "- " . $paragraphDivision[$i] . "." ."<br>"; ?></p>
        <?php } ?>
